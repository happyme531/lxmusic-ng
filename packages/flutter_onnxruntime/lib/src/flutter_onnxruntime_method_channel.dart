...
class MethodChannelFlutterOnnxruntime extends FlutterOnnxruntimePlatform {
  ...
  Future<Map<String, dynamic>> runInference(
    ...
    final processedPinnedOutputs = <String, dynamic>{};
    for (final entry in pinnedOutputs?.entries ?? const Iterable.empty()) {
      processedPinnedOutputs[entry.key] = {'valueId': entry.value.id};
    }
    ...
    final result = await methodChannel
        .invokeMethod<Map<Object?, Object?>>('runInference', {
          ...
          'requestedOutputs': requestedOutputs?.toList(growable: false),
          'pinnedOutputs': processedPinnedOutputs,
