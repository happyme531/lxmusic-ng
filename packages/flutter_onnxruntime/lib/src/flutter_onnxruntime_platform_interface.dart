...
abstract class FlutterOnnxruntimePlatform extends PlatformInterface {
  ...
  /// [requestedOutputs] limits the outputs allocated by ONNX Runtime
  /// [pinnedOutputs] binds caller-owned OrtValues as preallocated outputs
  /// [runOptions] is an optional map of run options
  Future<Map<String, dynamic>> runInference(
    String sessionId,
    Map<String, OrtValue> inputs, {
    Set<String>? requestedOutputs,
    Map<String, OrtValue>? pinnedOutputs,
  ...
  /// Creates a zero-filled OrtValue without transferring the tensor through Dart.
  Future<Map<String, dynamic>> createZeroOrtValue(
    String dataType,
    List<int> shape,
  ) {
    throw UnimplementedError('createZeroOrtValue() has not been implemented.');
  }
